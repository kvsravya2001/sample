...
<script>
    function adminFunc() {
		window.open("vehicle_data_insert_admin.php");
}
function adminFuncV() {
		window.open("vehicle_retrive_data_admin.php");
}
function headFuncV() {
		window.open("driver_data_insert_admin.php");
}
function headFunc() {
		window.open("driver_retrieve_data_admin.php");
}
function employeeFunc() {
		window.open("service_data_insert_admin.php");
}
function employeeFuncV() {
		window.open("service_retrieve_data_admin.php");
}
function headFuncVV() {
		window.open("tyre_data_insert_admin.php");
}
function headFuncVVV() {
		window.open("tyre_retrieve_data_admin.php");
}
function ins() {
		window.open("tyre_repair_data_insert_admin.php");
}
function insV() {
